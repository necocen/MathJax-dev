...
%ranges = (
  "Main" => [["Main R",
               0x20,0x28,0x29,0x2B,0x2C,[0x2E,0x3E],       # some basic latin
	         [0x5B,0x5E],[0x61,0x7D],
	       [0xA0,0xB4],0xD7,0xF7,                      # some latin1 supplement
...
#              [0x391,0x3C9],[0x3D1,0x3D6],[0x3F1,0x3F5],  # Greek
	       [0x2000,0x2026],0x2032,                     # Punctuation
               0x20D7,                                     # over arrow
...
#	       [0x2660,0x2663], [0x266D,0x266F],           # suits and music
	       ...
	       [0x2AAF,0x2AB0],                            # more operators
	     ],
	     ["Main B",
               0x28,0x29,0x2B,0x2C,[0x2E,0x3E],            # some basic latin
	         [0x5B,0x5E],[0x61,0x7D],
